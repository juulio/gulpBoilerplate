...
node -v  
npm -v  
![alt text](http://github.com/julio.delvalle/gulp-boilerplate/raw/master/app/img/nodeNpmGulpversion.png "Node Npm Gulp Version")

2. On a terminal type **git clone git@github.com:julio.delvalle/gulp-boilerplate.git** to clone the project into the desired folder.
